	...
	var Sidemenu = (function (_super) {
	    ...
	    function Sidemenu(props) {
	        ...
	        this.contract = function () {
	            _this.setState({ flat: false });
	        };
	        this.flat = function () {
	            _this.setState({ flat: true });
	        };
	        this.state = { flat: !!props.defautFlatStatus };
	    }
	    Sidemenu.prototype.render = function () {
	        var className = 'UISidemenu';
	        if (this.state.flat) {
	            className += ' ' + 'flat';
	        }
	        return (React.createElement("div", {className: className, onMouseEnter: this.flat, onMouseOut: this.contract}, this.props.children));
	    };
	    return Sidemenu;
	}(React.Component));
